...
@RestController
@RequestMapping("/api/fitpal-kafka")
public class FitpalKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FitpalKafkaResource.class);
    ...
    public FitpalKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
